...
var Conversation = (function () {
  ...
  function displayMessage(newPayload, typeValue) {
    ...
    if (isUser !== null && textExists) {
	  ...
	  //console.log(newPayload.intents[0].intent === "category_spend_graph")
      var responses = buildMessageDomElements(newPayload, isUser);
	  //alert(2) 	
      var chatBoxElement = document.getElementById(ids.chatFlow)
	  if(newPayload.input.text.includes('categorical') && !isUser){
		  //alert(1)
		//document.getElementById(ids.chatFlow).innerHTML+="<div><a href=\"https://plot.ly/~sravanbrahma/0/?share_key=7G67USIPPMr5unoCJTueEn\" target=\"_blank\" title=\"basic-histogram\" style=\"display: block; text-align: center;\"><img src=\"https://plot.ly/~sravanbrahma/0.png?share_key=7G67USIPPMr5unoCJTueEn\" alt=\"basic-histogram\" style=\"max-width: 100%;width: 600px;\"  width=\"600\" onerror=\"this.onerror=null;this.src='https://plot.ly/404.png';\" /></a><script data-plotly=\"sravanbrahma:0\" sharekey-plotly=\"7G67USIPPMr5unoCJTueEn\" src=\"https://plot.ly/embed.js\" async></script></div>"
		document.getElementById(ids.chatFlow).innerHTML+="<div id=\"myDiv\"><!-- Plotly chart will be drawn inside this DIV --></div>"
		chatBoxElement = document.getElementById(ids.chatFlow);
		var data = [{
  values: [19, 26, 30,25],
